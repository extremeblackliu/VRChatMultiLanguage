...
namespace Unity
{
	...
	public:
		...
		CGameObject* GetChildren(const char* m_pName)
		{
			return reinterpret_cast<CGameObject * (UNITY_CALLING_CONVENTION)(void*, System_String*)>(GameObjectFunctions.m_pGetChildren)(this, IL2CPP::String::New(m_pName));
		}
	};
